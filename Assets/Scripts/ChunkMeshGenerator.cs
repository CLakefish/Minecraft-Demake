...
public class ChunkMeshGenerator
{
    ...
    private TextureLoad TextureLoaderInstance;
    private WorldGenerator Generator;
    private Queue<CreateMesh> MeshesToCreate;
    public bool Terminate;

    public ChunkMeshGenerator(TextureLoad textureLoaderInstance, WorldGenerator worldGen)
    {
                            ...
                            try
                            {
                                if (Data[BlockToCheck.x, BlockToCheck.y, BlockToCheck.z] == 0)
                                {
                                    if (Data[BlockPos.x, BlockPos.y, BlockPos.z] != 0)
                                    {
                                        ...
                                        TextureLoad.CubeTexture TextureToApply = TextureLoaderInstance.Textures[CurrentBlockID];
